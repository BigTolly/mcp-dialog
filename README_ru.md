...
MCP имеет защиту от завершения диалога по таймауту, для этого он перезапускает MCP через 2 минуты, можно задать любое время.
...
Если завершить диалог, когда ИИ пишет (не думает), то это сделает общение с ИИ полностью бесплатным.
